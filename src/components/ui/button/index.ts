...
export const buttonVariants = cva(
  'ap-inline-flex ap-items-center ap-justify-center ap-whitespace-nowrap ap-rounded-md ap-text-sm ap-font-medium ap-transition-colors focus-visible:ap-outline-none focus-visible:ap-ring-1 focus-visible:ap-ring-ring disabled:ap-pointer-events-none disabled:ap-opacity-50',
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: 'ap-h-10 ap-rounded-md ap-px-8',
        icon: 'ap-h-9 ap-w-9',
      },
    },
    defaultVariants: {
